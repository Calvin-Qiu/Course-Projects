...
public class IteratorTests {
    ...
    public void testReachableFrom() {
        ...
        while (reachableFrom.hasNext()) {
            ...
            assertTrue(REACHABLEFROMTESTSQAURES.contains(s));
            numSquares += 1;
            squares.add(s);
        }
        assertEquals(REACHABLEFROMTESTSQAURES.size(), numSquares);
        assertEquals(REACHABLEFROMTESTSQAURES.size(), squares.size());
    }
    ...
    public void testLegalMoves() {
        Board b = new Board();
        buildBoard(b, LEGALMOVESBOARD);
        int numMoves = 0;
        Iterator<Move> legalMoves = b.legalMoves(Piece.BLACK);
        while (legalMoves.hasNext()) {
            numMoves++;
        }
        assertEquals(704, numMoves);
    }
    ...
    static final Set<Square> REACHABLEFROMTESTSQAURES =
    ...
    static final Piece[][] LEGALMOVESBOARD =
    {
        { E, E, E, E, E, E, E, S, E, E },
        { E, E, E, E, E, E, E, S, W, W },
        { E, E, E, E, E, E, E, S, E, S },
