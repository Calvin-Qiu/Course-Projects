...
public class UnitTest {
    ...
    public void testInit() {
        ...
        assertEquals(Piece.EMPTY, b.get(Square.sq("a8")));
    }
    ...
    public void testLegal() {
        Board b = new Board();
        Move m1 = Move.mv("g1 g2 g3");
        Move m2 = Move.mv("g1 g2 g2");
        Move m3 = Move.mv("g12 g222 g333");
        Move m4 = Move.mv("a7 a10 a11");
        assertEquals(true, b.isLegal(m1));
        assertEquals(false, b.isLegal(m2));
        assertEquals(false, b.isLegal(m3));
        assertEquals(false, b.isLegal(m4));
    }
