...
class Camera {
  ...
  */
  ...
  Ray generate_ray_relativistic(double x, double y) const;
  Ray generate_ray_relativistic_by_wavelength(double x, double y, float wavelength) const;
  ...
  double gamma;
  double delay;
  Matrix4x4 lab_to_cam;
  Matrix4x4 cam_to_lab;
